...
export default function Usuarios() {
    ...
    const pessoas = [
        {
            ...
            usuario: "aurora",
            nome: 'Aurora',
            sobrenome: "de Oliveira Cordeiro",
            ativoSN: 1,
            email: "aurora@gmail.com",
            telefone: "61985192989",
            grupo: 'comum',
    ...
    const colunas = [
        { head: 'Nome de Usuário', value: 'username' },
        { head: 'Nome', value: 'nome' },
        { head: 'Sobrenome', value: 'sobrenome' },
        { head: 'Grupo', value: 'grupo' },
        { head: 'Status', value: 'status' },
    ]

    const handleAdd = () => navigate('/sistema/cadastro_usuarios')
    ...
    const handleEdit = async (obj) => {
        ...
        //     `${getApiLeadUrl()}/nrn/pessoas?id=${obj.id}`,
        //     {
        //         headers: headers,
        //     }
        ...
        // navigate(`/cadastros/cadastro_pessoa/${obj.id}`, { state: res.data[0] })
        console.log(obj);
        navigate(`/sistema/cadastro_usuarios`, { state: obj })
    }
    ...
    const handleDelete = async (obj) => {
        try {
            ...
            //     `${getApiLeadUrl()}/nrn/pessoas/del?id=${obj.id}`,
            //     {
            //         headers: headers,
            //     }
            // );
    ...
    return (
        <div>
            <div className="mt-2 ml-2 md:mt-10 md:ml-10 bg-white rounded-3xl dark:bg-main-dark-bg">
                <Header title="Usuários do Sistemas" category="" />
            ...
            <div class="m-2 md:m-10 p-2 bg-white  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex justify-between m-4 relative">
                        ...
                        <div>
                            <button
                                type="submit"
                                onClick={handleAdd}
                                className="mr-4 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><RiUserAddFill /></button>
                        </div>
                    </div>
                ...
                <TabelaSimples dados={pessoas} colunas={colunas} edit handleEdit={handleEdit} handleDelete={handleOpenModal} />
            </div>
