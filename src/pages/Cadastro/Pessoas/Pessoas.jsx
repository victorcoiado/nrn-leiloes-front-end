...
export default function Pessoas(pessoas_data) {


    const [pessoas, setPessoas] = useState(pessoas_data?.pessoas_data)
    ...
    const colunas = [
        ...
        { head: 'Tipo Pessoa', value: 'tipoDePessoa' },
    ...
    const handleAdd = () => navigate('/cadastros/cadastro_pessoa')
    ...
    return (
        <div>
            <div className="mt-2 ml-2 sm:mt-20 md:mt-20 md:ml-10 bg-white rounded-3xl dark:bg-main-dark-bg">
                <Header title="Pessoas" category="Aqui você encontra as pessoas cadastradas" />
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between my-4 relative">
                        <div>
                            ...
                            <Busca value={text} onChange={search => setText(search)} />
