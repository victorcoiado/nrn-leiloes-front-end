...
export default function ProcessosSetores(processos_setores) {

    const [pSetores, setPSetores] = useState(processos_setores?.processos_setores)
    ...
    const colunas = [
        { head: 'Setores do Processo', value: 'descricao' },
    ]

    const handleAdd = () => navigate('/manutencao/cadastro_processo-setores')


    const handleEdit = (obj) => {

        navigate(`/manutencao/cadastro_processo-setores/${obj.id}`)
    }
    ...
    const handleDelete = async (obj) => {
        try {
            ...
            setPSetores(ress.data.processos_setores)
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setPSetores(res.data.processos_setores)
    ...
    return (
        <div>
            ...
            <div class="m-2 md:m-10 p-2 bg-white  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <TabelaSimples dados={pSetores} colunas={colunas} edit handleEdit={handleEdit} handleDelete={handleOpenModal} />
            </div>
