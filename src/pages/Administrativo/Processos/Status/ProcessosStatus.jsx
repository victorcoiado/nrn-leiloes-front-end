...
export default function ProcessosStatus(processos_status) {
    const [processosStatus, setProcessosStatus] = useState(processos_status?.processos_status)
    ...
    const colunas = [
        { head: 'Status do Processo', value: 'descricao' },
    ]

    const handleAdd = () => navigate('/manutencao/cadastro_processo-status')

    const handleEdit = (obj) => {

        navigate(`/manutencao/cadastro_processo-status/${obj.id}`)
    }
    ...
    const handleDelete = async (obj) => {
        try {
            ...
            setProcessosStatus(ress.data.processos_status)
    ...
    return (
        <div>
            <div className="mmt-2 ml-2 sm:mt-20 md:mt-20 md:ml-10 bg-white rounded-3xl dark:bg-main-dark-bg">
                <Header title="Processo - Status" />
            ...
            <div class="m-2 md:m-10 p-2 bg-white  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between my-4 relative">
                        ...
                        <Tooltip
                            content="Cadastrar um status do processo"
                            placement="left"
                            style='dark'
                            className='w-max'
                        >
                            <div>
                                <button
                                    type="submit"
                                    onClick={handleAdd}
                                    className="mr-0 sm:mr-4 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><RiFileAddFill />
                                </button>
                            </div>
                        </Tooltip>
                    </div>
                ...
                <TabelaSimples dados={processosStatus} colunas={colunas} edit handleEdit={handleEdit} handleDelete={handleOpenModal} />
            </div>
