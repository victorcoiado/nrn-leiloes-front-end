...
export default function ProcessosAcoes(processos_acoes) {

    const [pAcoes, setPAcoes] = useState(processos_acoes?.processos_acoes)
    ...
    const colunas = [
        { head: 'Ações do Processo', value: 'descricao' },
        { head: 'Judicial', value: 'JudicialSN' },

    ]



    const handleAdd = () => navigate('/manutencao/cadastro_processo-acoes')

    const handleEdit = (obj) => {

        navigate(`/manutencao/cadastro_processo-acoes/${obj.id}`)
    }
    ...
    const handleDelete = async (obj) => {
        try {
            ...
            setPAcoes(ress.data.processos_acoes)
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setPAcoes(res.data.processos_acoes)
    ...
    return (
        <div>
            <div className="mt-2 ml-2 sm:mt-20 md:mt-20 md:ml-10 bg-white rounded-3xl dark:bg-main-dark-bg">
                <Header title="Tipo de Ações do Processo" />
            ...
            <div class="m-2 md:m-10 p-2 bg-white  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between my-4 relative">
                        ...
                        <Tooltip
                            content="Cadastrar um tipo de ações do processo"
                            placement="left"
                            style='dark'
                            className='w-max'
                        >
                ...
                {loading ?
                    <Loading />
                    :
                    <TabelaSimples dados={pAcoes} colunas={colunas} edit handleEdit={handleEdit} handleDelete={handleOpenModal} />
                }
            </div>
