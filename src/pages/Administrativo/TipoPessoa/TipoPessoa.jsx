...
export default function Pessoas(pessoas_tipos) {

    const [tipoPessoas, setTipoPessoas] = useState(pessoas_tipos?.pessoas_tipos)
    console.log(tipoPessoas);
    ...
    const colunas = [
        { head: 'Tipo Pessoa', value: 'descricao' },
    ]

    const handleAdd = () => navigate('/manutencao/cadastro_pessoa-tipo')

    const handleEdit = (obj) => {

        navigate(`/manutencao/cadastro_pessoa-tipo/${obj.id}`)
    }
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setTipoPessoas(res.data.pessoas_tipo)
    ...
    return (
        <div>
            ...
            <div class="m-2 md:m-10 p-2 bg-white  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex justify-between my-4 relative">
                        <div>
                            ...
                            <input type="text" id="table-search-users" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 w-50 sm:w-80 rounded-lg  bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Busca pelo tipo de pessoa" />
                        </div>

                        <Tooltip
                            content="Cadastrar um tipo de pessoa"
                            placement="left"
                            style='dark'
                            className='w-max'
                        >
                ...
                <TabelaSimples dados={tipoPessoas} colunas={colunas} edit handleEdit={handleEdit} handleDelete={handleOpenModal} />
